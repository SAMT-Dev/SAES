...
<div class="m-5 mx-5 grid grid-cols-2 gap-2 text-center text-black dark:text-white">
	<div class="rounded-lg bg-amber-300">
		...
		<input
			class="rounded-lg bg-black/50 text-center font-bold text-black placeholder:text-black dark:text-white"
			type="text"
		...
		<input
			type="text"
			class="mb-2 rounded-lg bg-black/50 text-center font-bold text-black placeholder:text-black dark:text-white"
			name="maintenance"
