...
async fn main() {
    ...
    loop {
        ...
        println!(" ");
        println!("==== UNI TAXI aktuális hét ====");
        println!(" ");
        handle_tables("UNI TAXI", "B3:C22", "C3", "current", Apis::SCKK).await;
        println!(" ");
        println!("==== UNI TOW aktuális hét ====");
        println!(" ");
        handle_tables("UNI TOW", "B3:C22", "C3", "current", Apis::TOW).await;
        println!(" ");
        println!("=======================");
        println!(" ");
        ...
        println!(" ");
        println!("==== UNI TAXI előző hét ====");
        println!(" ");
        handle_tables("UNI TAXI", "H3:I22", "I3", "previous", Apis::SCKK).await;
        println!(" ");
        println!("==== UNI TOW előző hét ====");
        println!(" ");
        handle_tables("UNI TOW", "H3:I22", "I3", "previous", Apis::TOW).await;
        println!(" ");
        println!("=======================");
        println!(" ");
