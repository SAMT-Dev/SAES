...
<div class="bg-gray-950 h-screen w-screen text-white text-center pointer-events-none select-none">
	...
	{#if setupStep === 0}
		<div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80vw]">
			<h1 class="mt-2 text-5xl font-regular mb-3 animate-pulse">Üdv a SAMT App-ban!</h1>
			...
			<button
				onclick={() => (setupStep = 1)}
				class="font-bold uppercase bg-blue-600 text-xl px-2 py-1 rounded-xl hover:bg-blue-800 transition-all duration-200 cursor-pointer pointer-events-auto animate-bounce"
